...
require_once("function/functions.php");
    ...
    if(isset($_POST['register'])&&$_POST['register']){
        ...
        if(isset($_POST['contact'])) {
            ...
            print '<script>window.alert("problème !");
                    </script>';
        } 
?>
                ...
                <!-- debut nouveau patient -->
                            ...
                            <form method="post">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="nom-naissance" id="nom-naissance"  required> 
                                </div>
                                <div class="col-12">
                                
                                    <label for="numero-securite-sociale"> Numéro de sécurité sociale :</label>
                                    <input type="number" name="numero-securite-sociale" id="numero-securite-sociale"  required> 
                                </div>
                                <div class="col-12">
                                    <label for="birthdate">Date de naissance :</label>
                                    <input type="date" name="date-de-naissance" class="form-control " id="birthdate"  required>
                                </div>
                                <div class="col-12">
                                <label for="port">Téléphone portable :
                                <input type="tel" pattern="^(?:0|\(?\+33\)?\s?|0033\s?)[1-79](?:[\.\-\s]?\d\d){4}$"  name="numero-de-telephone-portable" class="form-control " id="port"  placeholder="exemple : 0600000000"  required>
                                </label> 
                                </div>
                                <div class="col-6">
