                                ...
                                if (isset($_GET["patient"])&&$_GET["patient"]=="register") {
                                    ...
                                    if($verif==true){
                                        ...
                                        if ($dao->getError()) {
                                            ...
                                            $send=sendMail($_POST['mail-register'],$_POST["firstName"]." ".$_POST["lastName"],"Confirmation d'inscription",str_replace("##token##","patient=register&user=login",file_get_contents("mail-register.html")));
                                            if ($send===true) {
...
<body>
    ...
    <?php } ?>
        <form method="post" class="row g-3 needs-validation" novalidate>
            <legend><h4 class=''>Vous avez déjà un compte</h4></legend>
            <br/>               
            ...
            <legend><h4 class="">Vous n'avez pas encore de compte</h4></legend>
               ...
               ?>
                ...
                <div class="col-md-6">
                    ...
                    <select name="mutual" id="mutual" class="form-control " required>
